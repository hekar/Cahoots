...
public class UsersView extends ViewPart implements UserChangeEventListener, DisconnectEventListener{
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "cahoots-eclipse.viewer");
		makeActions();
		hookContextMenu();

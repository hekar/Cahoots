...
public class UpdateMessage extends Message {
	...
	public UpdateMessage(final int offset, final int length, final String text) {
		this.offset = offset;
		this.length = length;
		this.text = text;
	}
	...
	public void setOffset(final int updatedOffset) {
	...
	public void setLengthOfReplacedText(final int length) {
		this.length = length;
	}
	...
	public String toString() {
		final StringBuffer buf = new StringBuffer("UpdateMessage["); //$NON-NLS-1$

...
public class UsersRecord extends org.jooq.impl.UpdatableRecordImpl<com.cahoots.jooq.tables.records.UsersRecord> {
	...
	private static final long serialVersionUID = 2104003694;
	 ...
	 * The table column <code>public.users.username</code>
	 */
	public java.util.List<com.cahoots.jooq.tables.records.ChatRecord> fetchChatListByFrom() {
		return create()
			.selectFrom(com.cahoots.jooq.tables.Chat.CHAT)
			.where(com.cahoots.jooq.tables.Chat.CHAT.FROM.equal(getValue(com.cahoots.jooq.tables.Users.USERS.USERNAME)))
			.fetch();
	}
	 ...
	 * The table column <code>public.users.username</code>
	 */
	public java.util.List<com.cahoots.jooq.tables.records.ChatRecord> fetchChatListByTo() {
		return create()
			.selectFrom(com.cahoots.jooq.tables.Chat.CHAT)
			.where(com.cahoots.jooq.tables.Chat.CHAT.TO.equal(getValue(com.cahoots.jooq.tables.Users.USERS.USERNAME)))
			.fetch();
	}
